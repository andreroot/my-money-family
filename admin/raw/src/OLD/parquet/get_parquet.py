...
def get_parquet_silver(parquet_file: str = None, tipo_docu: str = None, s3_options: dict = None) -> pd.DataFrame:
    ...
    Exemplo de chamada para S3:
      generate_process(s3_path="s3://medalion-cust/silver/credito|debito/credito_2025.parquet|extrato_2026.parquet")
