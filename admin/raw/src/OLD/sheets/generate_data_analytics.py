...
def pulling(df, ano):
    ...
    print(f"-->ENTRADA / DEBITO / PULLING", "\n")
...
# TRANSFORMACAO DO DADOS DE PAGAMENTO 
def payment_cred(df, ano):

    print(f"-->ENTRADA / CREDITO / PAYMENT", "\n")
