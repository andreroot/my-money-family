...
def generate_analytics_sheets_pushout(df, ano, aba):
    ...
    # gera dentro do csv de depara uma aba com os tipos de custo nulos
    generate_depara_tipo_custo_nulo(df, "debito")
...
def generate_analytics_sheets_pushout_cred(df, ano, aba):
    ...
    # gera dentro do csv de depara uma aba com os tipos de custo nulos
    generate_depara_tipo_custo_nulo(df, "credito")
...
def generate_depara_tipo_custo_nulo(df, tipo_docu):
