...
from datamyfin.mygcptablefinfam import insert_df_credits
...
def my_credits(df, path, file ):
    ...
    if len(df):
        ...
        insert_df_credits(my_credits_pushout_money(path, df), f'{path}/json/credits.json','devsamelo2.dev_domestico.credito_2024_excel')
